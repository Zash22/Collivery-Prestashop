...
class mycarrier extends CarrierModule
{
	...
	*/
	...
	public function install()
	{
		...
		Configuration::updateValue('MYCARRIER1_CARRIER_ID', 'mds_2');
		Configuration::updateValue('MYCARRIER2_CARRIER_ID', 'mds_3');
		if (!parent::install() ||
